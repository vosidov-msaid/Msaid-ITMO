...
public class Main{
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Введите количество знаков после запятых: ");
        int fraction_count = scanner.nextInt();
        scanner.close();
        ...
        ConvertMatrixToTable.printMatrixAsTable(w1, fraction_count, w, x);
    }
}
